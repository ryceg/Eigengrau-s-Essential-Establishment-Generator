setup.createBuilding = function() {
    ...
    var lighting          = ["poorly lit", "somewhat dark", "dimly lit", "well lit", "brightly lit", "well lit with several candles", "well lit with several torches", "well lit, with a couple lanterns", "well lit by the fire"].random();
