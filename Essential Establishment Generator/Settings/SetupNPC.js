        ...
        case "dragonborn":
            Object.assign(npc, {
                ...
                note.push: [["$npc.firstname is covered in glimmering red scales, which seem to turn a slight orange color in the sunlight.",
                      ...
                      "$npc.firstname has poor control over $npc.hisher breath weapon, and when $npc.heshe is agitated, $npc.hisher nostrils and mouth crackle with lightning/exude a green gas/smoke like chimneys drip green acid/breath puffs of frosty white air.",
                      ...
                      "$npc.firstname ‘s voice seems to come from within, rather than from $npc.hisher lips and mouth moving when $npc.heshe talks.",
                      ...
                      "$npc.firstname has albinism, making it hard to tell what exact kind of dragonborn $npc.heshe is.",
                      ...
                      "$npc.firstname’s scales are a dull faded red color, but glow bright red when $npc.heshe is aroused or in love.",
                      "$npc.firstname has the power to make $npc.hisher scales shine with bright neon colors on command.",
                      "$npc.firstname’s singing voice is the exact opposite tone of $npc.hisher speaking voice (for example, if $npc.firstname is female and has a higher voice, $npc.heshe will sing in a deep bass-baritone). It’s always a beautiful voice regardless, making them better performers.",
                      ...
                      "$npc.firstname has a cold and keeps accidentally setting off a mild version of $npc.hisher breath weapon every time $npc.heshe sneezes, which is often.",
                      "Whenever $npc.heshe uses $npc.hisher breath attack, $npc.hisher eyes shine bright white.",
                      "$npc.firstname has weak and useless vestigial wings coming out of $npc.hisher shoulders that $npc.heshe tries to keep hidden.",
                      "When sleeping, $npc.heshe exhale harmless clouds of smoke from $npc.hisher nostrils.",
