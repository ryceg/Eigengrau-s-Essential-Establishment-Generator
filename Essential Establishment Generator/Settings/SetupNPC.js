setup.createNPC = function() {
  ...
  var firstname;
	var age           =  ["childlike", "rather young", "eighteen year old", "surprisingly young", "relatively young", "relatively young", "middle aged", "middle aged", "middle aged", "middle aged", "mid aged", "relatively old", "sun wizened", "quite old", "ancient"].random();
  var lastname      = State.variables.name.last.pluck();
  var eyeColours;
  var racesingular;
  var raceplural;
  var raceadjective;
  ...
  var haircolour    = ["brunette", "brunette", "brown", "brownish", "auburn", "amber", "hazel" "redhead", "dark redhead", "blonde", "dark blonde", "white", "platinum," "black", "black"];
    ...
    switch (race) {
    case "human":
        eyeColours  = ["yellow", "amber", "brown", "hazel", "green", "blue", "gray", "aqua", "brown", "hazel", "green", "blue", "gray", "aqua", "red", "purple", "pale brown", "pale blue", "pale green", "ash gray"].random();
        racesingular  = "person";
        raceplural    = "humans";
        raceadjective = "man";
        racelanguage  = "Common";
    ...
    case "elf":
      ...
      break;
  	case "half-orc":
      eyeColours  = ["yellow", "amber", "brown", "hazel", "green", "blue", "gray", "aqua", "red"].random();
