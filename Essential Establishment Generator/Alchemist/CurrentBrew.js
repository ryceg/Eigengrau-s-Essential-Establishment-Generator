/*setup.createAlchemistBrew = function() {
  ...
  var vessel = [
    ...
    "cauldron",
    "vat",
    "flask with an oddly shaped neck",
    "flask",
    "pot",
    "saucepan"
    ].random();
  ...
  var purpose = [
    ...
    "magical cure-all",
    "terrible poison",
    "component for a summoning ritual",
    "component for a necromantic ritual",
    "component for a polymorphing hex",
    "component for a beguiling charm",
    "potent acid solvent",
    "potentially explosive substance",
    "substitute for alcohol",
    "substitute for drugs",
    "substitute for food",
    "substitute for animal feed"
    ].random();
