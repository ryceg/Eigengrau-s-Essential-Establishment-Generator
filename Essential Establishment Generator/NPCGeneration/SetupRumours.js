...
//         rumour.PersonalInformation = ["gives a secret about " + minorBoon(),
...
//         rumour.LocalInformation = ["tells of " + MajorBoon() + " concerning the area",
...
//   // D – Faction
//   function Faction() {
//         rumour.Faction = ["mystery cult that " + MysteryCult(),
...
//   // E – Minor Bane
//   function MinorBane() {
//         rumour.MinorBane = ["disease or pestilence",
//         "buildings destroyed",
...
//   // F – Major Bane
//   function MajorBane() {
//         rumour.MajorBane = ["bad luck (random penalties[disadvantage] to random die rolls) for 1 month or 10 combats",
...
//   // G – Minor Boon
//   function MinorBoon() {
//         rumour.MinorBoon = ["enemy (q) (r) has been temporarily thwarted",
...
//   // H – Major Boon
//   function MajorBoon() {
//         rumour.MajorBoon = ["divine intervention grants a " + Treasure(),
...
//   // I – Vendetta
//   function Vendetta() {
//         rumour.Vendetta = ["wrongfully jailed or persecuted",
//         "racial crusade",
...
//   // J – On The Run
//   function OnTheRun() {
//         rumour.OnTheRun = ["committed political crime",
...
//         rumour.BuyingOrSelling = ["cloth: raw or finished",
...
//   // M – Minor Quest
//   function MinorQuest() {
//         rumour.MinorQuest = ["commune with avatar",
//         "map a location",
//         "deliver a message",
...
//   // N – Major Quest
//   function MajorQuest() {
//         rumour.MajorQuest = ["awaken a sleeping npc called " + setup.createNPC(),
...
//   // O – Good Deeds
//   function GoodDeeds() {
//         rumour.GoodDeeds = ["freeing an innocent from imprisonment",
...
//   // P – Evil Deeds
//   function EvilDeeds() {
//         rumour.EvilDeeds = ["humiliate and torture a rival",
...
//   // Q – Minor Enemy
//   function MinorEnemy() {
//         rumour.MinorEnemy = ["snubbed ex-friend",
//         "school bully",
//         "business rival",
//         "local thug",
//         "romantic rival",
...
//   // R – Major Enemy
//   function MajorEnemy() {
//         rumour.MajorEnemy = ["a politician or political group",
...
//   // S – Haunted
//   function Haunted() {
//         rumour.Haunted = ["spirits locked in battle",
...
//   // T – Cursed
//   function Cursed() {
//         rumour.Cursed = ["time moves at a different speed",
...
//   // V – Emergency
//   function Emergency() {
//         rumour.Emergency = ["political power is dead or arrested/exiled",
//         "business in trouble",
...
//   // W – Warning
//   function Warning() {
//         rumour.Warning = ["a powerful enemy is coming for you",
...
//         rumour.SocialEvents = ["an invitation to an upcoming event (party, play, etc..) given by a mysterious stranger.",
...
//         rumour.PoliticalEvents = ["opposition gains control through a coup",
...
//         rumour.ReligiousEvents = ["avatar issues sanctions",
...
//         rumour.FaithTouched = ["dreams of the lives of those who gave their lives in sacrifice for the faith",
...
//         rumour.WeaveTouched = ["a living mask of a jester can be found here, hidden, but waiting. the parasite sleeps.",
...
//         rumour.MysteryCult = ["trying to return/exile/free/enslave/destroy/rebirth a minor/major deity",
