...
export function AdventureOutput() {
  return <h3>Place #1 - The Murder Site</h3>You come across the body of a woman lying in one of the back alleys near $adventure.tavern.name. She's well dressed, very pale, and roughly 45 years of age. It is not exactly clear how she died, but her eyes are bulging.
