...
export function wageVariation (town: Town, npc: NPC) {
...
export function npcGrossIncome (town: Town, npc: NPC) {
  // TODO add hobbies
...
export function npcLifestyleExpenses (town: Town, npc: NPC) {
