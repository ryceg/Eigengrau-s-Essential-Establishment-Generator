...
export function createRoad (options?: Partial<Options>) {
  ...
  if (noEncounter) {
    return `${random(['You walk along the ', 'You trudge along the ', 'Making your way across the countryside on the ', 'You make your way along the ', 'You walk along the ']) + road.descriptiveType}, ${road.traffic}.`
  } else {
    return `${random(['You walk along the ', 'You trudge along the ', 'Making your way across the countryside on the ', 'You make your way along the ', 'You walk along the ']) + road.descriptiveType}, ${road.traffic}${random([random([' until you come across ', ' and encounter ', ' and cross paths with ', ' and come across ', ' and see in the distance ', ' and spy in the distance ']), `. ${random(['Turning the corner, you come across ', 'Then, in the distance, you see ', 'You walk for a while, and then come across ', 'You walk for a few more minutes, until you come across ', 'You walk along for a while, and then encounter '])}`])}${road.encounter}.`
  }
}
