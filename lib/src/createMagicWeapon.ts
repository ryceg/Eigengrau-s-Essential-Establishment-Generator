...
export function createMagicWeapon (): MagicWeapon {
  ...
  const prefixWeaponRoll = random(propertyWeapon.length - 1)
  const suffixWeaponRoll = random(propertyWeapon.length - 1)
