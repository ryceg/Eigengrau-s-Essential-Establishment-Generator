...
setup.townSquare = {
  ...
  feature: [
    ...
    'small boxes of ' + setup.flora.flowers.stemP.random() + ' and ' + setup.flora.flowers.stemP.random() + ' lining the streets.',

    'large boxes of ' + setup.flora.flowers.stemP.random() + ', ' + setup.flora.flowers.stemP.random() + ', ' +
    setup.flora.flowers.stemP.random() + ', and ' + setup.flora.flowers.stemP.random() + ' lining the streets.',
