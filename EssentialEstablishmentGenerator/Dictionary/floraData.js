setup.flora = {
 ...
 //list of more common fruits, singular
    'fruitS' : ['apple', 'almond', 'apricot', 'banana', 'blackberry', 'blueberry', 'boysenberry', 'cherry', 'coconut', 'date', 'dragonfruit', 'elderberry', 'fig', 'gooseberry', 'grape', 'raisin',
   'honneyberry', 'juniper berry', 'kiwi', 'lemon', 'lime', 'mango', 'honeydew', 'watermelon', 'mulberry', 'nectarine', 'orange', 'papaya', 'peach', 'pear', 'plum', 'prune', 'pineapple',
   'pomegranite', 'raspberry', 'star fruit', 'strawberry'],
