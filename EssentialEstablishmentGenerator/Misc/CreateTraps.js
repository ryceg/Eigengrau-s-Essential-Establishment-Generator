// setup.createTraps = function(base) {
...
//           "pulling on a suspicious looking rope hanging from the ceiling"].random(),
//         signal: [
...
//           "lighting a rather inviting looking torch in the center of the room"].random(),
//         signal: [
//           "a low hum is heard",
...
//           "one can hear a deathly silence"].random(),
//         payload: [
...
//           "another more sinister trap is set in another room"].random(),
//
//       });
//       break;
//     default:
...
//   }
//
//   trap.output = ["This trap is activated by ", "This trap is triggered by "].random() + trap.trigger + ". When activated, " + trap.signal + ". " + ["The trap then delivers its payload: ", "Then, ", "And then, "].random() + trap.payload + ".";
//   return trap.output;
// };
