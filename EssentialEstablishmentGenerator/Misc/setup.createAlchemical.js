setup.createAlchemy = function (base) {
  ...
  var bodyPartOrigin = ['beggar', 'beautiful woman', 'addict', 'accused man', 'assassin', 'artisan', 'barber', 'barbarian', 'cuckold', 'witch', 'wizard', 'warlock', 'priest', 'thief', 'pauper', 'cheat', 'scammer', 'crook', 'pirate', 'princess', 'torturer', 'prisoner', 'rebel', 'traitor', 'traitor', 'coward', 'coward']
  var commonHerb = ["Adder's Tongue", 'Cinquefoil', 'Hemp', 'Footleaf', 'Agrimony', 'Colewort', 'Henbane', 'Periwinkle', 'Sweet Trefoile', 'Coltsfoot', 'Horehound', "Prince's Feather", 'AllHeale', 'Comfrey', 'Ironhard', "Shepherd's Purse", 'Aloe', 'Cow Parsnip', 'Wormwood', 'Rose Campion', 'Angelica', 'WillowHerb', 'Land Caltrops', 'Rue', 'Anise', 'Darnell', "Leopard's Bane", 'Saddilia', 'Arnica', 'Deadly Nightshade', 'Lesser Centaury', 'Saffron', 'Asarabacca', 'Dittany', 'Lungwort', 'Sanicle', 'Ash', 'Dog Rose', 'Makebate', 'Galingale', 'Balm', 'Mugwort', 'Mandrake', 'Scented Mayweed', 'Mountain Setwall', 'Dwarf Mallow', 'Marigold', 'Serapias Turbith', 'Woodrose', 'Marjerome', 'Fennel', 'Bilberry', 'Masterwort', 'Spiderwort', 'Milkworte', "Bishop's Weed", 'Fetherfew', "Hare's Ears", 'Chamomile', 'Pennyroyal', 'Valerian', 'Tamariske', 'Chervil']
  var herb = ['bloodgrass', 'chromus slime', 'ephedra', 'emetic wax', 'fennel silk', 'gengko bush', 'hyacinth nectar', 'lavender sprigs', 'mandrake root', 'wild sageroot', 'arctic creeper', 'amanita cap', 'basilisk breath', 'cactus juice', 'drakus flower', 'harrada leaf', 'quicksilver lichen', 'radiant synthseed', 'spineflower berries', 'wyrmtongue petals', 'arrow root', 'blue toadshade', 'cosmos glond', "Devil's bloodleaf", "fiend's ivy", 'hydrathistle', 'ironwood heart', 'luminous cap dust', 'mortflesh powder', 'nightshade berries', 'primordial balm', 'rock vine', 'scilia beans', 'silver hibiscus', 'tail leaf', 'verdant nettle', 'voidroot', 'wispstalks', 'wrackwort bulbs']
  var herbPreservation = ['distilled liquid of', 'essence of', 'oil of', 'paste made from', 'pickled', 'powdered', 'dried', 'preserved']
  var substanceForm = ['chips', 'cubes', 'disks', 'flakes', 'granules', 'gravel', 'chunks', 'nuggets', 'pebbles', 'polyhedrons', 'powder', 'rocks', 'sequins', 'small cylinders', 'wire']
  var substanceType = ['amber', 'brimstone', 'bronze', 'brass', 'chitin', 'coal', 'emerald', 'ruby', 'sapphire', 'incense', 'iron', 'steel', 'obsidion', 'turquoise', 'opal', 'jade', 'pearl', 'rust', 'salt']
  var liquidTitle = ['potion', 'elixir', 'draught', 'vial', 'philter', 'tonic', 'brew', 'ichor', 'juice', 'concoction']
  var potionTitleRoll = random(0, 99)
  ...
  var potionContainer = ['conical smooth glass bottle', 'square glass bottle', 'not quite watertight leather waterskin', 'stone flask', 'metal thermos', 'glass syringe', 'small medical vial', 'small shot sized bottle', 'large metal bottle', 'capped horn', 'rather decorative glass bottle', 'geometric diamond shaped bottle', 'translucent long wine bottle', 'translucent beer bottle', 'leather pouch', 'spray bottle', 'coloured bottle', 'bone flask', 'small metal vial', 'large bottle that can be swigged several times']
  var vesselDescriptor = ['delicate', 'tiny', 'heavy-bottomed', 'thick', 'grimy', 'polished', 'shiny', 'blackened', 'well-worn', 'round-bottomed', 'quite large', 'comically large']
  var vesselMaterial = ['ceramic', 'iron', 'copper', 'steel', 'bronze', 'glass', 'glass']
  var vesselType = ['tea kettle', 'cauldron', 'vat', 'flask with an oddly shaped neck', 'flask', 'pot', 'saucepan']
  var liquidColour = ['clear', 'blue', 'green', 'red', 'pale green', 'pink', 'light blue', 'white', 'black', 'dark grey', 'light grey', 'yellow', 'orange', 'gold', 'orange', 'bronze', 'metallic', 'purple', 'brown', 'dark red']
  var liquidSecondary = ['flecks of colour', 'swirls of colour', 'fizzing bubbles', 'bubbles suspended in it', 'some kind of bone floating in it', 'leaves and flowers in it', 'two separating liquid', 'a bright glow', 'a soft glow', 'stripes of colour', 'translucency', 'a cloudy murkiness', 'blood within it', 'dirt floating in it', 'chunks of metal in it', 'some type of gore from a slain creature', 'steam coming from it', 'a face in the liquid', 'constantly moving and shifting liquid', 'a constant heat']
  var liquidTexture = ['thick and sludgy', 'thin and watery', 'airy and bubbly', 'slimey', 'almost solid', 'oily', 'chunky', 'bitty', 'milky', 'almost gaseous']
  var taste
