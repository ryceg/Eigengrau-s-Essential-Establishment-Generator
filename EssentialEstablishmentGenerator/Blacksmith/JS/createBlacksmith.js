...
setup.createBlacksmith = function () {
  var blacksmith = setup.createNPC({
    ...
    owner: ['owner', 'caretaker', 'proud owner', 'proprietor', 'current owner', 'chief owner', 'master smith', 'resident smith'].random(),
    ...
    currentproject: ["a <<print either($smithy.weapons)>> for Lord $lord.lastName's son.",
