...
setup.createBlacksmith = function (town, smithy) {
  var blacksmith = setup.createNPC(town, {
    ...
    currentproject: ["a <<print either($smithy.weapons)>> for a lord's son.",
      ...
      'fleshing out the stock of the shop at the moment. Mostly general items like nails, horeshoes, and what not'].seededrandom()
  })
  return blacksmith
}
