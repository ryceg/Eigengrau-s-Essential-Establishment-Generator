...
setup.townData = {
  ...
  'professions': {
    'actor': { sv: 2500, availability: 1, type: 'profession' },
    'advocate': { sv: 3250, availability: 1, type: 'profession' },
    'advisor': { sv: 780, availability: 1, type: 'profession' },
    'animal handler': { sv: 250, availability: 1, type: '' },
    'apothecarist': { sv: 450, availability: 1, type: 'business' },
    'architect': { sv: 550, availability: 1, type: 'profession' },
    'archivist': { sv: 2450, availability: 1, type: 'profession' },
    'armorer': { sv: 750, availability: 1, type: 'business' },
    'astrologer': { sv: 950, availability: 1, type: '' },
    'baker': { sv: 800, availability: 1, type: 'business' },
    'banker': { sv: 2250, availability: 1, type: '' },
    'barber': { sv: 350, availability: 1, type: 'business' },
    'barkeep': { sv: 450, availability: 1, type: 'business' },
    'blacksmith': { sv: 750, availability: 1, type: 'business' },
    'bookseller': { sv: 6300, availability: 1, type: 'business' },
    'brewer': { sv: 550, availability: 1, type: 'business' },
    'bricklayer': { sv: 650, availability: 1, type: 'business' },
    'brothel keeper': { sv: 850, availability: 1, type: 'business' },
    'buccaneer': { sv: 1350, availability: 1, type: '' },
    'butcher': { sv: 1150, availability: 1, type: 'business' },
    'caravanner': { sv: 1450, availability: 1, type: '' },
    'carpenter': { sv: 550, availability: 1, type: 'business' },
    'cartographer': { sv: 1950, availability: 1, type: '' },
    'chandler': { sv: 700, availability: 1, type: '' },
    'chef': { sv: 1850, availability: 1, type: '' },
    'clergyman': { sv: 40, availability: 1, type: '' },
    'clock maker': { sv: 4550, availability: 1, type: 'profession' },
    'cobbler': { sv: 1550, availability: 1, type: '' },
    'cook': { sv: 450, availability: 1, type: '' },
    'cooper': { sv: 700, availability: 1, type: '' },
    'counselor': { sv: 1650, availability: 1, type: 'profession' },
    'courtesan': { sv: 1950, availability: 1, type: '' },
    'courtier': { sv: 1950, availability: 1, type: 'profession' },
    'cowherd': { sv: 250, availability: 1, type: '' },
    'dancer': { sv: 2250, availability: 1, type: '' },
    'diplomat': { sv: 3450, availability: 1, type: 'profession' },
    'distiller': { sv: 450, availability: 1, type: 'business' },
    'diver': { sv: 3250, availability: 1, type: '' },
    'farmer': { sv: 150, availability: 1, type: '' },
    'fisherman': { sv: 170, availability: 1, type: '' },
    'fishmonger': { sv: 250, availability: 1, type: '' },
    'furrier': { sv: 250, availability: 1, type: '' },
    'gardener': { sv: 550, availability: 1, type: '' },
    'general': { sv: 2250, availability: 1, type: 'profession' },
    'gladiator': { sv: 3250, availability: 1, type: '' },
    'glovemaker': { sv: 2400, availability: 1, type: 'business' },
    'goldsmith': { sv: 6550, availability: 1, type: 'business' },
    'grocer': { sv: 450, availability: 1, type: '' },
    'guardsman': { sv: 150, availability: 1, type: '' },
    'guildmaster': { sv: 4150, availability: 1, type: '' },
    'hatmaker': { sv: 950, availability: 1, type: 'business' },
    'healer': { sv: 950, availability: 1, type: '' },
    'herald': { sv: 550, availability: 1, type: '' },
    'herbalist': { sv: 850, availability: 1, type: 'business' },
    'hermit': { sv: 950, availability: 1, type: '' },
    'historian': { sv: 4150, availability: 1, type: 'profession' },
    'hunter': { sv: 250, availability: 1, type: '' },
    'ice seller': { sv: 1950, availability: 1, type: '' },
    'innkeeper': { sv: 750, availability: 1, type: 'business' },
    'inventor': { sv: 2250, availability: 1, type: 'profession' },
    'jailer': { sv: 1250, availability: 1, type: '' },
    'jester': { sv: 2250, availability: 1, type: '' },
    'jeweler': { sv: 400, availability: 1, type: 'business' },
    'judge': { sv: 850, availability: 1, type: 'profession' },
    'knight': { sv: 1150, availability: 1, type: '' },
    'lady': { sv: 1550, availability: 1, type: '' },
    'leatherworker': { sv: 750, availability: 1, type: 'business' },
    'librarian': { sv: 3150, availability: 1, type: 'profession' },
    'linguist': { sv: 5150, availability: 1, type: 'profession' },
    'locksmith': { sv: 1900, availability: 1, type: 'business' },
    'lord': { sv: 1150, availability: 1, type: '' },
    'lumberjack': { sv: 350, availability: 1, type: '' },
    'maid-servant': { sv: 250, availability: 1, type: '' },
    'mason': { sv: 500, availability: 1, type: 'business' },
    'masseur': { sv: 1550, availability: 1, type: 'profession' },
    'merchant': { sv: 650, availability: 1, type: 'business' },
    'messenger': { sv: 1250, availability: 1, type: '' },
    'midwife': { sv: 650, availability: 1, type: '' },
    'miller': { sv: 650, availability: 1, type: 'business' },
    'miner': { sv: 550, availability: 1, type: '' },
    'minister': { sv: 950, availability: 1, type: 'profession' },
    'minstrel': { sv: 1450, availability: 1, type: '' },
    'monk': { sv: 1450, availability: 1, type: '' },
    'mortician': { sv: 650, availability: 1, type: 'profession' },
    'necromancer': { sv: 6150, availability: 1, type: '' },
    'noble': { sv: 3150, availability: 1, type: 'profession' },
    'nun': { sv: 2150, availability: 1, type: 'profession' },
    'nurse': { sv: 1150, availability: 1, type: 'profession' },
    'officer': { sv: 1150, availability: 1, type: '' },
    'painter': { sv: 1500, availability: 1, type: 'business' },
    'patissier': { sv: 1500, availability: 1, type: '' },
    'perfumer': { sv: 3150, availability: 1, type: 'business' },
    'philosopher': { sv: 7150, availability: 1, type: 'profession' },
    'physician': { sv: 4150, availability: 1, type: 'profession' },
    'pilgrim': { sv: 5150, availability: 1, type: '' },
    'potter': { sv: 1150, availability: 1, type: 'business' },
    'priest': { sv: 750, availability: 1, type: '' },
    'privateer': { sv: 1150, availability: 1, type: '' },
    'professor': { sv: 3150, availability: 1, type: 'profession' },
    'roofer': { sv: 1800, availability: 1, type: '' },
    'ropemaker': { sv: 1850, availability: 1, type: 'business' },
    'rugmaker': { sv: 1850, availability: 1, type: 'business' },
    'saddler': { sv: 1000, availability: 1, type: 'business' },
    'sailor': { sv: 150, availability: 1, type: '' },
    'scabbard maker': { sv: 875, availability: 1, type: 'business' },
    'sculptor': { sv: 250, availability: 1, type: 'business' },
    'scavenger': { sv: 350, availability: 1, type: '' },
    'scholar': { sv: 2250, availability: 1, type: 'profession' },
    'seamstress': { sv: 450, availability: 1, type: '' },
    'servant': { sv: 350, availability: 1, type: '' },
    'shaman': { sv: 750, availability: 1, type: '' },
    'shepherd': { sv: 150, availability: 1, type: '' },
    "ship's captain": { sv: 950, availability: 1, type: '' },
    'shoemaker': { sv: 150, availability: 1, type: '' },
    'silversmith': { sv: 1250, availability: 1, type: 'business' },
    'slave': { sv: 150, availability: 1, type: '' },
    'slaver': { sv: 650, availability: 1, type: '' },
    'smith': { sv: 750, availability: 1, type: 'business' },
    'soldier': { sv: 1000, availability: 1, type: '' },
    'spice merchant': { sv: 1500, availability: 1, type: 'business' },
    'squire': { sv: 950, availability: 1, type: '' },
    'stablehand': { sv: 550, availability: 1, type: '' },
    'stevedore': { sv: 550, availability: 1, type: '' },
    'stonemason': { sv: 750, availability: 1, type: '' },
    'steward': { sv: 950, availability: 1, type: '' },
    'street seller': { sv: 550, availability: 1, type: '' },
    'street sweeper': { sv: 450, availability: 1, type: '' },
    'student': { sv: 3150, availability: 1, type: '' },
    'surgeon': { sv: 4150, availability: 1, type: 'profession' },
    'surveyor': { sv: 1150, availability: 1, type: 'profession' },
    'tailor': { sv: 250, availability: 1, type: '' },
    'tanner': { sv: 200, availability: 1, type: '' },
    'tavernkeeper': { sv: 450, availability: 1, type: 'business' },
    'tax collector': { sv: 1850, availability: 1, type: 'profession' },
    'teacher': { sv: 1450, availability: 1, type: 'profession' },
    'thatcher': { sv: 350, availability: 1, type: '' },
    'thief': { sv: 850, availability: 1, type: '' },
    'torturer': { sv: 1850, availability: 1, type: '' },
    'town crier': { sv: 750, availability: 1, type: '' },
    'toymaker': { sv: 2150, availability: 1, type: 'profession' },
    'vendor': { sv: 1150, availability: 1, type: '' },
    'veterinarian': { sv: 1250, availability: 1, type: 'profession' },
    'vintner': { sv: 850, availability: 1, type: '' },
    'weaver': { sv: 600, availability: 1, type: '' },
    'wetnurse': { sv: 350, availability: 1, type: '' },
    'woodcarver': { sv: 2450, availability: 1, type: 'business' },
    'wood seller': { sv: 2150, availability: 1, type: 'business' },
    'wrestler': { sv: 6150, availability: 1, type: '' },
    'writer': { sv: 7150, availability: 1, type: 'profession' }
  }
}
