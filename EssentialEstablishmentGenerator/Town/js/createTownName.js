setup.createTownName = function () {
  var prefix = ['Green', 'Elms', 'Oak', 'Fair', 'Farren', 'Tall', 'Nar', 'Alla', 'Lans', 'San', 'Col', 'Fri', 'Plain', 'Hon', 'Far', 'Barrow', 'Shi', 'Mel', 'Mal', 'Bon', 'Bie', 'Can', 'Pol', 'Pan',
    ...
    'Cha', 'Agni', 'Val', 'Vas', 'Bug', 'Tre', 'Haj', 'Par', 'Roz', 'Hlod', 'Lunin', 'Lun', 'Jast'].seededrandom()
  var suffix = ['dale', 'ten', 'den', 'ven', 'gen', 'len', 'lun', 'stun', 'ville', 'burn', 'view', 'nen', 'lan', 'sed', 'folk', 'ork', 'len', 'pan', 'rel', 'old', 'ten', 'tan', 'lend', 'vorn', 'vant',
    ...
    'ki', 'halas', 'wek', 'diu', 'arsk', 'glod'].seededrandom()
  var name
  if (random(100) > 90) {
    console.log('Named a founder!')
    name = setup.npcData.raceTraits['human'].lastName.seededrandom() + suffix
  } else {
    name = prefix + suffix
  }
