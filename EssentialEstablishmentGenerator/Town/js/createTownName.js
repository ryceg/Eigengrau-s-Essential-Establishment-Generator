setup.createTownName = function () {
  var prefix = ['Green', 'Elms', 'Oak', 'Fair', 'Farren', 'Tall', 'Nar', 'Alla', 'Lans', 'San', 'Col', 'Fri', 'Plain', 'Hon', 'Far', 'Barrow', 'Shi', 'Mel', 'Mal', 'Bon', 'Bie', 'Can', 'Pol', 'Pan',
  ...
  'ter', 'ton', 'beck', 'bach', 'bost', 'mouth', 'bourne', 'born', 'borough', 'by', 'bie', 'caster', 'chester', 'cott', 'dale', 'don', 'den', 'eig', 'ey', 'field', 'firth', 'hurst', 'lynn', 'lin', 'mere',
   ...
   'hau', 'hausen', 'heim', 'hof', 'horn', 'horst', 'hoven', 'ich', 'in', 'itz', 'kirch', 'leben', 'leiten', 'loh', 'ow', 'siefen', 'stadt', 'stein', 'wald', 'weg', 'werder', 'weiger', 'winkel', 'tal'].random()
  var name
  if (random(100) > 90) {
    console.log('Named a founder!')
    name = setup.npcData.raceTraits['human'].lastName.random() + suffix
  } else {
    name = prefix + suffix
  }
