setup.tavernSleep = function (tavern, bartender) {
  ...
  setup.tavernWakeUp = function (tavern, bartender) {
    if (tavern.wealth === 'kingly') {
  ...
  tavern.sleepOutput = setup.closestMatch(setup.getSleep(tavern, bartender), 'note', 'restfulness', 'sleepEasy', 'restfulness', 'sleepEasy')
  ...
  setup.tavernWakeUp(tavern, bartender)
