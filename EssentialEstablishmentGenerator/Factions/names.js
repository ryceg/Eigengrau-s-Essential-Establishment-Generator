setup.nameFaction = function (type) {
  ...
  var name = [
    'The ' + setup.factionData.type[type].group.random() + ' of ' + setup.factionData.type[type].adjective.random() + ' ' + setup.factionData.type[type].main.random(),
    'The ' + setup.factionData.type[type].group.random() + ' of ' + setup.factionData.type[type].main.random(),
    'The ' + setup.factionData.type[type].adjective.random() + ' ' + setup.factionData.type[type].group.random(),
    'The ' + setup.factionData.type[type].main.random() + ' of ' + State.variables.town.name,
    'The ' + State.variables.town.name + ' ' + setup.factionData.type[type].main.random(),
    setup.factionData.type[type].unique.random()
  ].random()
