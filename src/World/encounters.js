setup.initMiscEncounters = () => {
  setup.misc.encounters = {
    ...
    'lots of bats': () => 'lots of bats',
    'many spider webs': () => 'many spider webs',
    "a troll's stash": () => "a troll's stash",
    'some abandoned mining equipment': () => 'some abandoned mining equipment',
    'bare rock': () => 'bare rock',
    'a potable spring': () => 'a potable spring',
    'mummified remains': () => 'some mummified remains',
    'a band of dwarvish refugees': () => 'a band of dwarvish refugees',
    'a swarm of beetles': () => 'a swarm of beetles',
