...
setup.createSmithy = function (town, opts) {
  ...
  smithy.structure.smithyDescriptor = smithy.structure.material.wealth + ' ' + smithy.structure.material.noun + ' ' + smithy.wordNoun + ' with ' + setup.articles.output(smithy.structure.roof.verb) + ' roof'
