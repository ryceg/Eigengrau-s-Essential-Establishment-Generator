  ...
  get: {
    ...
    note (generalStore) {
      ...
      const note = [
        ...
        `all of the walls are painted ${lib.articles.output(colour1)} colour${['', '', '', ` with ${colour2} coloured accents`, `, and the ceiling is ${colour2} coloured`, `, and the floors have been painted a ${colour2} color`].random()}`,
