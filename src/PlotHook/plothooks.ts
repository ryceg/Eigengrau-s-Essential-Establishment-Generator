...
export const plothooks = [
  ...
  // 'Nobody Hurts Ma': {
  //
  //   exclusions: function (town: Town) {
  //     return true
  //   },
  //   function: function (town: Town) {
  // @ts-ignore
  ...
  },
  {
    ...
    function (town: Town) {
      ...
      return `${setup.profile(building, '', 'town.buildings')} is looking for a bard to entertain the crowds on Thursday Nights (mug for a copper night).`
    }
  },
  {
  ...
  },
  {
    ...
    function (town: Town) {
      // @ts-ignore
      const building = lib.findInArray(town.buildings, 'buildingType', 'tavern') || setup.createNewBuilding(town, 'Tavern')
      return `Needed bartender. Looking to employ a bartender for my inn, ${setup.profile(building, '', 'town.buildings')}. Must be able to listen to political rants on the slower days. NO GOBLINS`
    }
  },
  {
  ...
  },
  {
    ...
    function (town: Town) {
      ...
      const building = lib.findInArray(town.buildings, 'buildingType', 'tavern') || setup.createNewBuilding(town, 'Tavern')
      // #
      return `${setup.profile(building, '', 'town.buildings')} needs (at least one more) bouncer for annual all-you-can-drink QuaffFest Celebration tomorrow. Usual bouncer called in sick and can’t make it. Will pay 5s/hr and after your shift that evening all your drinks are free!`
    }
  },
  {
  ...
  },
  {
    ...
    function (town: Town) {
      ...
      // #
      return `NEEDED: Someone competent in the ways of word to berate, yell, and speak ill of ${setup.profile(npc, 'me')}. Willing to pay. Discretion is key. Meet me during the night 2 alleys up from ${setup.profile(building, '', 'town.buildings')} in order to discuss terms.`
    }
  },
  {
  ...
  },
  {
    ...
    function (town: Town) {
      ...
      return `Fence need painted. Good pay. Contact ${setup.profile(npc)} at ${setup.profile(building, '', 'town.buildings')}. Twist is, the fence is 10 feet tall and almost a mile long.`
    }
  },
  {
