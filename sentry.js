(function () {
    ...
    ***************************************************************************** */
                ...
                logger[name] = function () {
                    ...
                    if (enabled) {
                        consoleSandbox(function () {
                            var _a;
                            (_a = global$a.console)[name].apply(_a, __spread([PREFIX + "[" + name + "]:"], args));
                        });
                    }
                };
            });
    ...
    isLocalCopy()||init({dsn:"https://92c3fb4ac9054e9987d39969cc55969a@o365643.ingest.sentry.io/5469192",integrations:[new BrowserTracing,new CaptureConsole({levels:["error"]})],tracesSampleRate:.2});
